...
public class HCEditController {
	...
	public static void setMyfileVO(MyFileVO myfileVO) {
		HCEditController.myfileVO = myfileVO;
	}
    ...
    void btnEditClicked(ActionEvent event) {
    	...
    	hcVO.setBh_mem_id("kim52");
    	hcVO.setBh_updatewt("kim52");
    ...
    void btnFileClicked(ActionEvent event) {
    	...
    	//창을 열었을떄 보여줄 폴더
		filechooser.setInitialDirectory(new File("/Users/chewoop/Desktop/projectImages"));
    ...
    @FXML
    void initialize() {
        assert btnEdit != null : "fx:id=\"btnEdit\" was not injected: check your FXML file 'HCEdit.fxml'.";
        assert editTitle != null : "fx:id=\"editTitle\" was not injected: check your FXML file 'HCEdit.fxml'.";
        assert editContent != null : "fx:id=\"editContent\" was not injected: check your FXML file 'HCEdit.fxml'.";
        assert editFile != null : "fx:id=\"editFile\" was not injected: check your FXML file 'HCEdit.fxml'.";
        assert btnFile != null : "fx:id=\"btnFile\" was not injected: check your FXML file 'HCEdit.fxml'.";
        assert btnCancel != null : "fx:id=\"btnCancel\" was not injected: check your FXML file 'HCEdit.fxml'.";
