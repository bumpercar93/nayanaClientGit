...
import nayana.controller.communityPage.RegisterNoticeController;
import nayana.vo.BoardNoticeVO;
import nayana.vo.MemberVO;
import util.AlertUtil;
import util.MyButtonEventHandler;

public class AdNoticeBoardController {
   ...
   public static void setMemVO(MemberVO memVO) {
      AdNoticeBoardController.memVO = memVO;
   }
   ...
   public void setPrimaryStage(Stage primaryStage) {
    ...
    void tableViewClicked(MouseEvent event) {
        ...
        try {
           ...
           FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/adminPage/AdShowNotice.fxml"));
           Parent shownoti = loader.load();
           
           AdShowNoticeController controller = loader.getController(); // ---
    ...
    void writeBtnClicked(ActionEvent event) {
    	...
    	try {
            ...
            AdRegisterNoticeController.setMemVO(memVO); ////////////////////// 넘겨주기
            
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/adminPage/AdRegisterNotice.fxml"));
            Parent root = loader.load();
             
            AdRegisterNoticeController controller = loader.getController(); // 새로 데이터
            controller.setNoticeBoardController(this); ////////////////////////////////////////////////////////
    ...
    @FXML
    void initialize() {
        assert tableView != null : "fx:id=\"tableView\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert numberCol != null : "fx:id=\"numberCol\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert titleCol != null : "fx:id=\"titleCol\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert writerCol != null : "fx:id=\"writerCol\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert dateCol != null : "fx:id=\"dateCol\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert cntCol != null : "fx:id=\"cntCol\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert pagination != null : "fx:id=\"pagination\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert comboBox != null : "fx:id=\"comboBox\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert SearchtxtField != null : "fx:id=\"SearchtxtField\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert searchBtn != null : "fx:id=\"searchBtn\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
        assert writeBtn != null : "fx:id=\"writeBtn\" was not injected: check your FXML file 'AdNoticeBoard.fxml'.";
