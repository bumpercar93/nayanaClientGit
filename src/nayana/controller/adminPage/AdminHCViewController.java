...
import nayana.controller.communityPage.HCEditController;
...
public class AdminHCViewController {
	...
	public static void setBhVO(BoardHealthVO bhVO) {
		AdminHCViewController.bhVO = bhVO;
	}
	...
	public static void setMemVo(MemberVO memVo) {
		AdminHCViewController.memVO = memVo;
	}
    ...
    void btnDeleteClicked(ActionEvent event) {
    	...
    	try {
    		...
    		BorderPane b = (BorderPane) btnDelete.getScene().getRoot();
    		b.setCenter(root);
    ...
    void btnEditClicked(ActionEvent event) {
    	try {
    		...
    		AdminHCEditController.setHcVo(bhVO);
    		AdminHCEditController.setMemVo(memVO);
    		AdminHCEditController.setMyfileVO(myfileVO);
    		
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../fxml/adminPage/AdminHCEdit.fxml"));
    		Parent root = loader.load();
    ...
    @FXML
    void initialize() {
        assert viewDate != null : "fx:id=\"viewDate\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert viewTitle != null : "fx:id=\"viewTitle\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert btnEdit != null : "fx:id=\"btnEdit\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert viewImg != null : "fx:id=\"viewImg\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert viewTextArea != null : "fx:id=\"viewTextArea\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert btnList != null : "fx:id=\"btnList\" was not injected: check your FXML file 'AdminHCView.fxml'.";
        assert btnDelete != null : "fx:id=\"btnDelete\" was not injected: check your FXML file 'AdminHCView.fxml'.";
